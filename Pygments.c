 ...
 * contents of Pygments.xs. Do not edit this file, edit Pygments.xs instead.
 *
...
XS_EUPXS(XS_Text__Pygments_highlight); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Text__Pygments_highlight)
{
    dVAR; dXSARGS;
    if (items != 1)
...
extern "C"
#endif
XS_EXTERNAL(boot_Text__Pygments); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Text__Pygments)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("Text::Pygments::highlight", XS_Text__Pygments_highlight, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
